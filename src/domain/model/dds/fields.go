...
type Fields struct {
	...
	Resolution                    *dds.Resolution        `json:"resolution"`
	...
	Assignee                      *dds.Assignee          `json:"assignee"`
	...
	Reporter                      *dds.Reporter          `json:"reporter"`
	...
	Progress                      *dds.Progress          `json:"progress"`
	Votes                         *dds.Votes             `json:"votes"`
	Issuetype                     *dds.Issuetype         `json:"issuetype"`
	Project                       *dds.Project           `json:"project"`
	...
	Watches                       *dds.Watches           `json:"watches"`
	...
	Customfield10342              *dds.Customfield10342  `json:"customfield_10342"`
	Customfield13610              any                    `json:"customfield_13610"`
	Customfield11310              any                    `json:"customfield_11310"`
	Priority                      *dds.Priority          `json:"priority"`
	...
	Creator                       *dds.Creator           `json:"creator"`
	...
	Aggregateprogress             *dds.Aggregateprogress `json:"aggregateprogress"`
	...
	Customfield13925              *dds.Customfield13925  `json:"customfield_13925"`
