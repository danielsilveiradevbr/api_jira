...
type Fields struct {
	...
	Reporter                      *model.Reporter          `json:"reporter"`
	...
	Watches                       *model.Watches           `json:"watches"`
	...
	Customfield10342              *model.Customfield10342  `json:"customfield_10342"`
	...
	Aggregateprogress             *model.Aggregateprogress `json:"aggregateprogress"`
	...
	Customfield13925              *model.Customfield13925  `json:"customfield_13925"`
